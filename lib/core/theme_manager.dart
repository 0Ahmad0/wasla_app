...
class ThemeManager {
  ...
  static final myTheme = ThemeData(
    ...
    textButtonTheme: TextButtonThemeData(
      style: ButtonStyle(
        overlayColor:
            WidgetStatePropertyAll(ColorManager.secondaryColor.withOpacity(.1)),
    ...
    switchTheme: SwitchThemeData(
      ...
      thumbColor: WidgetStateProperty.resolveWith<Color>((states) {
        ...
        return ColorManager
            .notificationDateTimeGrayColor; // لون الكرة عند عدم التفعيل
      }),
      trackColor: WidgetStateProperty.resolveWith<Color>((states) {
        if (states.contains(WidgetState.selected)) {
          return ColorManager.secondaryColor
              .withOpacity(0.5); // لون المسار عند التفعيل
        }
